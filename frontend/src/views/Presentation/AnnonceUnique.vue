    ...
    <div
      ...
      <article class="grid grid-cols-[1fr] custom:grid-cols-[65%_35%] print:inline" id="grid">
        ...
        <article class="col-[1] row-[1] min-w-page-min">
          <!-- Photos -->
          <section class="relative" data-qa-id="adview_spotlight_container"><div class="_1o09v"><div class="flex"><section class="relative flex h-sz-320 w-full"><div class="shrink-0 grow-0 basis-1/3 first-of-type:pr-md last-of-type:pl-md"><button class="styles_ImageFit__iKSDp styles_cover__MsMH7 styles_fullWidth__4pjL_ styles_clickable__UxTEV"><picture><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/e0/94/49/e09449b780ef9125aea8053b8e35ffe42573cae9.jpg?rule=classified-1200x800-webp" type="image/webp" media="(min-width: 480px)"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/e0/94/49/e09449b780ef9125aea8053b8e35ffe42573cae9.jpg?rule=classified-1200x800-jpg" type="image/jpeg" media="(min-width: 480px)"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/e0/94/49/e09449b780ef9125aea8053b8e35ffe42573cae9.jpg?rule=classified-800x533-webp" type="image/webp"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/e0/94/49/e09449b780ef9125aea8053b8e35ffe42573cae9.jpg?rule=classified-800x533-jpg" type="image/jpeg"><img src="https://img.leboncoin.fr/api/v1/lbcpb1/images/e0/94/49/e09449b780ef9125aea8053b8e35ffe42573cae9.jpg?rule=ad-large" class="_1cnjm" alt="Lot de 5 radiateurs programmables ATLANTIC TATOU DIGITAL (image 1)"></picture></button></div><div class="shrink-0 grow-0 basis-1/3 first-of-type:pr-md last-of-type:pl-md"><button class="styles_ImageFit__iKSDp styles_cover__MsMH7 styles_fullWidth__4pjL_ styles_clickable__UxTEV"><picture><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/60/b7/3b/60b73b162e57560a5abb111860b89633dad4e481.jpg?rule=classified-1200x800-webp" type="image/webp" media="(min-width: 480px)"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/60/b7/3b/60b73b162e57560a5abb111860b89633dad4e481.jpg?rule=classified-1200x800-jpg" type="image/jpeg" media="(min-width: 480px)"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/60/b7/3b/60b73b162e57560a5abb111860b89633dad4e481.jpg?rule=classified-800x533-webp" type="image/webp"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/60/b7/3b/60b73b162e57560a5abb111860b89633dad4e481.jpg?rule=classified-800x533-jpg" type="image/jpeg"><img src="https://img.leboncoin.fr/api/v1/lbcpb1/images/60/b7/3b/60b73b162e57560a5abb111860b89633dad4e481.jpg?rule=ad-large" class="_1cnjm" alt="Lot de 5 radiateurs programmables ATLANTIC TATOU DIGITAL (image 2)"></picture></button></div><div class="shrink-0 grow-0 basis-1/3 first-of-type:pr-md last-of-type:pl-md"><button class="styles_ImageFit__iKSDp styles_cover__MsMH7 styles_fullWidth__4pjL_ styles_clickable__UxTEV"><picture><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/ff/43/e8/ff43e8f928f4d148b99d720fc68f1316329c31fc.jpg?rule=classified-1200x800-webp" type="image/webp" media="(min-width: 480px)"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/ff/43/e8/ff43e8f928f4d148b99d720fc68f1316329c31fc.jpg?rule=classified-1200x800-jpg" type="image/jpeg" media="(min-width: 480px)"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/ff/43/e8/ff43e8f928f4d148b99d720fc68f1316329c31fc.jpg?rule=classified-800x533-webp" type="image/webp"><source srcset="https://img.leboncoin.fr/api/v1/lbcpb1/images/ff/43/e8/ff43e8f928f4d148b99d720fc68f1316329c31fc.jpg?rule=classified-800x533-jpg" type="image/jpeg"><img src="https://img.leboncoin.fr/api/v1/lbcpb1/images/ff/43/e8/ff43e8f928f4d148b99d720fc68f1316329c31fc.jpg?rule=ad-large" class="_1cnjm" alt="Lot de 5 radiateurs programmables ATLANTIC TATOU DIGITAL (image 3)"></picture></button></div><button data-spark-component="button" class="u-shadow-border-transition box-border inline-flex items-center justify-center gap-md whitespace-nowrap px-lg text-body-1 font-bold focus-visible:outline-none focus-visible:u-ring [&amp;:not(:focus-visible)]:ring-inset min-w-sz-32 h-sz-32 rounded-lg bg-surface text-on-surface hover:bg-surface-hovered enabled:active:bg-surface-pressed focus-visible:bg-surface-focused absolute bottom-lg right-lg" aria-busy="false" aria-live="off">Voir les  photos</button></section><div class="absolute right-lg top-lg z-dropdown inline-flex w-[9.5rem] justify-between"><div class="ml-md"><div class="flex h-sz-40 w-sz-40 justify-center" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r1l:" data-state="closed" data-spark-component="popover-trigger"><button data-spark-component="button" class="u-shadow-border-transition box-border inline-flex items-center justify-center gap-md whitespace-nowrap px-lg text-body-1 font-bold focus-visible:outline-none focus-visible:u-ring [&amp;:not(:focus-visible)]:ring-inset min-w-sz-44 h-sz-44 rounded-lg bg-surface text-on-surface hover:bg-surface-hovered enabled:active:bg-surface-pressed focus-visible:bg-surface-focused px-none text-body-1" aria-busy="false" aria-live="off" aria-label="Partager"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-title="ShareOutline" fill="currentColor" stroke="none" class="fill-current text-current u-current-font-size" data-spark-component="icon" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d="m14.46,5.77v.03s-6.92,2.87-6.92,2.87c-.53-.28-1.13-.44-1.78-.44-2.08,0-3.77,1.69-3.77,3.77s1.69,3.77,3.77,3.77c.64,0,1.25-.16,1.78-.44l6.92,2.87s0,.02,0,.03c0,2.08,1.69,3.77,3.77,3.77s3.77-1.69,3.77-3.77-1.69-3.77-3.77-3.77c-1.36,0-2.55.72-3.22,1.8l-5.93-2.46c.29-.53.46-1.15.46-1.8s-.17-1.26-.46-1.8l5.93-2.46c.66,1.08,1.86,1.8,3.22,1.8,2.08,0,3.77-1.69,3.77-3.77s-1.69-3.77-3.77-3.77-3.77,1.69-3.77,3.77Zm3.77-1.77c-.98,0-1.77.79-1.77,1.77,0,.13.01.25.04.37.01.04.02.08.03.12.21.74.89,1.28,1.7,1.28.98,0,1.77-.79,1.77-1.77s-.79-1.77-1.77-1.77ZM6.89,13.37c.4-.32.65-.82.65-1.37s-.25-1.05-.65-1.37c-.03-.02-.07-.05-.1-.07-.29-.2-.64-.32-1.02-.32-.98,0-1.77.79-1.77,1.77s.79,1.77,1.77,1.77c.38,0,.73-.12,1.02-.32.03-.03.06-.05.1-.07Zm9.61,4.49s.02-.08.03-.12c.21-.74.89-1.28,1.7-1.28.98,0,1.77.79,1.77,1.77s-.79,1.77-1.77,1.77-1.77-.79-1.77-1.77c0-.13.01-.25.04-.37Z"></path></svg></button></div></div><div data-pub-id="clicked_annonce_saved_gallery" data-qa-id="adview_button_favorite_summary" class="z-raised"><div data-spark-component="popover-anchor"><div data-test-id="adview_button_favorite"><div class="styles_FavoriteButtonBubble__Vwihy"><button data-spark-component="button" class="u-shadow-border-transition box-border inline-flex items-center justify-center gap-md whitespace-nowrap px-lg text-body-1 font-bold focus-visible:outline-none focus-visible:u-ring [&amp;:not(:focus-visible)]:ring-inset min-w-sz-44 h-sz-44 rounded-lg bg-surface text-on-surface hover:bg-surface-hovered enabled:active:bg-surface-pressed focus-visible:bg-surface-focused px-none text-body-1" aria-busy="false" aria-live="off" aria-label="Sauvegarder"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-title="LikeOutline" fill="currentColor" stroke="none" class="fill-current text-current u-current-font-size" data-spark-component="icon" aria-hidden="true" focusable="false"><path d="m16.28,3c-1.72,0-3.24.83-4.28,2.11-1.04-1.28-2.57-2.11-4.28-2.11-3.21,0-5.72,2.85-5.72,6.24,0,2.77,1.41,4.75,1.97,5.51,1.87,2.47,4.38,4.11,6.67,5.6h.02c.25.17.49.33.73.49.32.21.73.22,1.06.02.21-.13.43-.26.63-.39h.02c2.39-1.48,5.02-3.1,6.95-5.68.64-.86,1.95-2.83,1.95-5.54,0-3.4-2.51-6.23-5.72-6.23h0Zm-8.57,2.12c1.46,0,2.76.96,3.35,2.39.16.38.52.64.93.64s.77-.25.93-.64c.6-1.44,1.9-2.39,3.36-2.39,1.99,0,3.7,1.79,3.69,4.13,0,2-.98,3.5-1.52,4.24-1.67,2.25-3.98,3.67-6.43,5.19l-.07.04-.21-.13c-2.33-1.52-4.54-2.97-6.18-5.14-.51-.67-1.54-2.18-1.54-4.2,0-2.33,1.7-4.13,3.7-4.13h0Z"></path></svg></button></div></div></div></div></div></div></div></section>
        
          <!-- Details -->
          <div class="mx-lg grid gap-lg py-xl border-b-sm border-b-neutral/dim-4 lg:mx-md undefined"><div class="flex flex-col gap-lg" data-qa-id="adview_spotlight_description_container"><h1 class="break-words text-headline-1-expanded undefined" data-qa-id="adview_title">Lot de 5 radiateurs programmables ATLANTIC TATOU DIGITAL</h1><div class="flex flex-wrap items-center"><div class="mr-md flex flex-wrap items-center justify-between" data-qa-id="adview_price"><div class="flex"><p class="text-headline-2  ">80&nbsp;€</p></div></div></div><div class="flex flex-col items-baseline justify-between gap-md md:flex-row"><p class="text-caption opacity-dim-1">aujourd’hui à 18:58</p><div class="flex items-center gap-sm text-surface"><div data-tip="Remonter en tête de liste" currentitem="false"><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-title="MoveUp" fill="currentColor" stroke="none" class="fill-current text-main w-sz-24 h-sz-24" data-spark-component="icon" aria-hidden="true" focusable="false"><path fill-rule="evenodd" d