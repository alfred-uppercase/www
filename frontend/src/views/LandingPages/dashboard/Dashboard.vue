    ...
    <div class="mx-auto max-w-page-max" v-if="userLoggedIn">
      ...
      <div class="flex flex-col gap-lg md:flex-row">
        ...
        <div class="grid gap-xl md:grid-cols-2 lg:grid-cols-3">
          ...
          <!--Mes transactions -->
          <RouterLink :to="{ name: 'MesTransactions' }"><div class="flex size-full items-center rounded-lg p-xl shadow md:flex-col md:items-start"><div class="mr-xl flex size-3xl min-w-sz-40 items-center"><span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: 40px; height: 40px; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative;"><img alt="" src="" decoding="async" data-nimg="fixed" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;" srcset=""></span></div><div class="md:mt-xl"><h2 class="text-headline-2">Transactions</h2><span class="text-body-1">Suivre mes achats et mes ventes</span></div></div>
          </RouterLink>
