$(function() {
    ...
    $('.selectVendor').click(function () {
        ...
        var chatBox = '<div class="box box-warning direct-chat direct-chat-primary">';
            ...
            chatBox += '<h3 class="box-title" id="appendTitle">Chat</h3>';
            ...
            chatBox += '<input type="text" name="message" placeholder="Message ..." class="form-control message">';
            chatBox += '<span class="input-group-btn">';
            chatBox += '<button type="button" class="btn btn-success btn-flat btnSend" id="nav_down">Envoyer</button>';
