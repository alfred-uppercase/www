...
function now_open($listing_id = '') {
  ...
  function add_listing()
  {
    ...
    $data['naturebien'] = sanitizer($this->input->post('naturebien'));
    $data['carateristique'] = sanitizer($this->input->post('carateristique'));
    $data['surface'] = sanitizer($this->input->post('surface'));
    $data['surfacetotal'] = sanitizer($this->input->post('surfacetotal'));
    $data['rooms'] = sanitizer($this->input->post('rooms'));
    $data['roomschambres'] = sanitizer($this->input->post('roomschambres'));
    $data['nombredeniveaux'] = sanitizer($this->input->post('nombredeniveaux'));
    ...
    $data['classeenergie'] = sanitizer($this->input->post('classeenergie'));
    $data['nombredetage'] = sanitizer($this->input->post('nombredetage'));
    $data['etagedevotrebien'] = sanitizer($this->input->post('etagedevotrebien'));
    $data['anneemodele'] = sanitizer($this->input->post('anneemodele'));
    $data['typevehicule'] = sanitizer($this->input->post('typevehicule'));
    $data['boitevitesse'] = sanitizer($this->input->post('boitevitesse'));
    $data['nombreplace'] = sanitizer($this->input->post('nombreplace'));
    $data['nombreporte'] = sanitizer($this->input->post('nombreporte'));
    $data['puissancefiscal'] = sanitizer($this->input->post('puissancefiscal'));
    $data['puissancedin'] = sanitizer($this->input->post('puissancedin'));
    $data['kilometrage'] = sanitizer($this->input->post('kilometrage'));
